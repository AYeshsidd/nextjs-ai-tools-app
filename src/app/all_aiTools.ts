...
export const allTools: Tool[] = [
  
  {
    slug: 'Hugging-Face',
    name: 'Hugging Face',
    description:'Leading platform for machine learning models, datasets and transformers.',
...
.`
  ...
  slug:"chatgpt",
  name:'GPT4',
  description:'Powerful language model by OpenAI for chat, writing, code and more.',
